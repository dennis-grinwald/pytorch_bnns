...
from src.bayesian_models.mcd_utils import DropoutConv2d, DropoutLinear

class MCD_CNN_8L_224_3C(nn.Module):
    def __init__(self, p=0.5):
        super(MCD_CNN_8L_224_3C, self).__init__()
...
# OLD 
class MCD_CNN_7L_Cifar10_small(nn.Module):
    def __init__(self, p=0.5):
        super(MCD_CNN_7L_Cifar10_small, self).__init__()
