...
#def main():
    ...
    # Pixel Image
    #img_1 = pixel_image(shape, sd=0.0)
    #img_2 = pixel_image(shape, sd=0.0)
    #print(img_1[0][0][0][0])
    #print(img_2[0][0][0][0])
    #print(img_1[0][0].flatten().shape)
    #print((img_1[0][0].flatten() == img_2[0][0].flatten()).sum())

    # FFT
    #img_1 = fft_image(shape, sd=0.0)
    #img_2 = fft_image(shape, sd=0.0)

    #img_1 = pixel_image(shape, sd=0.0)
    #img_2 = pixel_image(shape, sd=0.0)
    #print(img_1[0][0][0][0][0])
    #print(img_2[0][0][0][0][0])
    #print(img_1[0][0].flatten().shape)
    #print((img_1[0][0].flatten() == img_2[0][0].flatten()).sum())
